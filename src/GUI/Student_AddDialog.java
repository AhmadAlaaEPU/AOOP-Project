...
public class Student_AddDialog extends JDialog {
	...
	public void addStudent() {
		...
		Student student = new Student(userInfoPanel.textField_fullname.getText(), userInfoPanel.textField_mobileNumber.getText(), address, stage.id, department.id, coursesIds);
